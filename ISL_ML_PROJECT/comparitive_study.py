...
def calculate_metrics(method, label_test, label_pred):
    ...
    precision = skmetrics.precision_score(label_test, label_pred, average='micro')
    recall = skmetrics.recall_score(label_test, label_pred, average='micro')
    f1 = skmetrics.f1_score(label_test, label_pred, average='micro')
